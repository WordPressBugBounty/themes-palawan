...
?>
    ...
    <main class="site-main">
        <?php
        /**
         * palawan_carousel hook.
         *
         * @since 1.0.0
         *
         * @hooked palawan_constuct_carousel - 10
         */
        do_action('palawan_carousel');
        ?>

        <?php
        /**
         * palawan_cat_section hook.
         *
         * @since 1.0.0
         *
         * @hooked palawan_construct_cat_section - 10
         */
        do_action('palawan_cat_section');
        ?>
